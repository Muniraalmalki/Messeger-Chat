...
class ChatViewController: MessagesViewController {
    ...
    // declare to pass email to create chat
    //public var isNewConersation = false
    ...
    private var safeSender :Sender?  {
       ...
       return Sender(photoURL: "",senderId: email  , displayName: "munira")
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        if isNewConversation {
            print("Calling database createnew convo")
            ...
            print("Not a new convo")
            guard let conversationId = conversationId, let name = self.title else {
                return
            }

            // append to existing conversation data
            DatabaseManger.shared.sendMessage(to: conversationId,otherUserEmail:otherUserEmail ,name: name, newMessage: message) { success in
                if success {
                    print("message sent")
                }else {
                    print("failed to send")
